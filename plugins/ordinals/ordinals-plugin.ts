...
import { RareSatoshiHunter, RareSatoshiHunterOptions } from './rare-satoshi-hunter.js';
...
export const ordinalsPlugin = {
  ...
  initialize: (runtime: any) => {
    ...
    const ordPath = process.env.ORD_PATH || path.resolve(process.cwd(), '../Ord/ord-master/target/release/ord');
    const bitcoinConfPath = process.env.BITCOIN_CONF_PATH || '/Volumes/ordlibrary/bitcoin.conf';
    const explorerPath = process.env.ORDINALS_EXPLORER_PATH || path.resolve(process.cwd(), '../Ord/ord-master');
    ...
    const actions = {
      GET_INSCRIPTION_CONTENT: {
        ...
        handler: async (_runtime: any, _message: any, _state: any, options: any, callback: any) => {
          try {
      ...
      GET_INSCRIPTIONS: {
        ...
        handler: async (_runtime: any, _message: any, _state: any, options: any, callback: any) => {
          try {
            ...
            if (callback) await callback(inscriptions);
            return inscriptions;
          } catch (error) {
      ...
      GET_INSCRIPTION: {
        ...
        handler: async (_runtime: any, _message: any, _state: any, options: any, callback: any) => {
          try {
            ...
            if (callback) await callback(inscription);
            return inscription;
          } catch (error) {
      ...
      GET_SATOSHI_INFO: {
        ...
        handler: async (_runtime: any, _message: any, _state: any, options: any, callback: any) => {
          try {
            ...
            if (callback) await callback(satoshi);
            return satoshi;
          } catch (error) {
      ...
      GET_INSCRIPTION_TRANSFERS: {
        ...
        handler: async (_runtime: any, _message: any, _state: any, options: any, callback: any) => {
          try {
            ...
            if (callback) await callback(transfers);
            return transfers;
          } catch (error) {
      ...
      HUNT_RARE_SATOSHIS: {
        ...
        handler: async (_runtime: any, _message: any, _state: any, options: any, callback: any) => {
          try {
            const hunterOptions: RareSatoshiHunterOptions = {
      ...
      GET_SATOSHI_MARKET_STATS: {
        ...
        handler: async (_runtime: any, _message: any, _state: any, options: any, callback: any) => {
          try {
            ...
            if (callback) await callback(stats);
            return stats;
          } catch (error) {
