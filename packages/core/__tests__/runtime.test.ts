...
/**
 * Mock Database Adapter implementing the IDatabaseAdapter interface.
 * Contains mock implementations for various database operations such as initializing, closing, creating entities, searching memories, creating relationships, etc.
 */
...
// Mock Memory creator
/**
 * Creates a mock Memory object with the given parameters.
 * 
 * @param {string} text - The text content of the memory.
 * @param {UUID} [id] - The optional UUID for the memory.
 * @param {UUID} [entityId] - The optional entity ID for the memory.
 * @param {UUID} [roomId] - The optional room ID for the memory.
 * @param {UUID} [agentId] - The optional agent ID for the memory.
 * @returns {Memory} - The mock Memory object created.
 */
...
// Mock Character
/**
 * Represents a mock character used for testing purposes.
 * @type {Character}
 */
