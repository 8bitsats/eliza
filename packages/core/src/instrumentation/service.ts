...
/**
 * Declares a variable `pg` with the type of `import('pg')`.
 */
...
/**
 * PostgresSpanProcessor class that implements the SpanProcessor interface.
 * 
 * @class
 * @implements {SpanProcessor}
 * @property {import('pg').Client | null} pgClient Reference to the PostgreSQL client or null if not initialized
 * @property {boolean} isInitialized Flag to track if the processor is initialized
 * @property {boolean} isConnected Flag to track if the processor is connected
