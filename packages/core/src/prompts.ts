/**
 * Defines a template for deciding on behalf of an agent whether they should respond to a message, ignore it, or stop the conversation.
 * @type {string}
 */
 ...
 * 
 * This template includes placeholders for agent name, providers, valid actions, instructions, keys, and output format.
 * Use this template to generate dialog and actions for a specific character.
 * 
 * @type {string}
 */
...
/**
 * This constant represents the template for creating a post in a specific voice and style, customized with variables.
 * The template provides examples of tasks and their respective outputs, guiding users on how to structure their posts.
 * It also includes guidelines on formatting the output in XML format with specific fields such as thought, post, and imagePrompt.
 * Users are instructed to follow the character count limit, avoid questions, and focus on concise, impactful statements.
 */
